 ...
 * @author Runner
 * @version 1.0
 * @since 2025/8/29 15:25
 */
@Service
public class RedisVectorStoreManagementService implements VectorStoreManagementService{
    ...
    @Autowired
    public RedisVectorStoreManagementService(Gson gson, @Qualifier("mysqlAccessor") Accessor dbAccessor, DbConfig dbConfig,RedisVectorStore redisVectorStore) {
        this.gson = gson;
